...
class CredentialDialog:
    """Opens an additional window to prompt for a Google Cloud Vision API key"""
    api_key: str = ""
    ...
    def save(self):
        """Stores the entered API key to a config.json file in the current working directory"""
